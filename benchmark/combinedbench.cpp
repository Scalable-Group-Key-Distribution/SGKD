...
// //compile it using: g++ -std=c++17 -O2 -Wall yourfile.cpp -o benchmark -lcrypto -lssl
// template <typename F>
// uint64_t benchmark(F func) {
//     auto start = high_resolution_clock::now();
//     for (int i = 0; i < LOOP_COUNT; ++i) func();
//     auto end = high_resolution_clock::now();
//     return duration_cast<nanoseconds>(end - start).count() / LOOP_COUNT;
// }
...
//     auto t_sha256 = benchmark([&]() {
//         SHA256(input, sizeof(input), hash_out);
//     });
//     cout << "SHA256 Hash (avg): " << t_sha256 << " ns\n";
...
//     });
//     cout << "AES-CBC Encryption (avg): " << t_aes << " ns\n";

//     // HKDF (HMAC-based Extract and Expand)
//     auto t_hkdf = benchmark([]() {
...
//         HMAC_CTX_free(ctx);
//     });
//     cout << "HKDF-SHA256 (avg): " << t_hkdf << " ns\n";

//     // Modular Exponentiation
//     auto t_modexp = benchmark([]() {
...
//     });
//     cout << "Modular Exp (avg): " << t_modexp << " ns\n";

//     // Modular Inverse
//     auto t_modinv = benchmark([]() {
//         BN_CTX *ctx = BN_CTX_new();
...
//     });
//     cout << "Modular Inverse (avg): " << t_modinv << " ns\n";
...
//             BN_free(k);
//         });
//         cout << "EC Scalar Mult (avg): " << t_scalar_mult << " ns\n";

//         // Prepare random points for point addition
...
//         auto t_point_add = benchmark([&]() {
//             EC_POINT *R = EC_POINT_new(group);
//             EC_POINT_add(group, R, P, Q, NULL);
//             EC_POINT_free(R);
//         });
//         cout << "EC Point Addition (avg): " << t_point_add << " ns\n";
...
//     // Prepare dummy signature buffer
//     size_t siglen = 0;
...
//     // Prepare one valid signature for verification
//     RAND_bytes(msg, sizeof(msg));
...
//     cout << "ECDSA Sign (avg):   " << t_sign << " ns\n";
//     cout << "ECDSA Verify (avg): " << t_verify << " ns\n";
...
//compile using :g++ -std=c++17 -O2 -Wall combinedbench.cpp -o combinedbench -lcrypto -lssl
// Benchmark with average and standard deviation
// template <typename F>
// pair<double, double> benchmark_stats(F func) {
//     vector<double> times;
//     times.reserve(LOOP_COUNT);
...
//     double stddev = sqrt(sq_sum / LOOP_COUNT);
